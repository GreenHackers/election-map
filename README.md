...
This app is example and reference how to use MaePaySoh API on web and build an app. 
...
4)  Install the election map's local `npm` and `bower` dependencies.
...
This app build using Polymer based on Polymer Starter Kit. You can read more about Polymer Starter Kit on [https://github.com/PolymerElements/polymer-starter-kit](https://github.com/PolymerElements/polymer-starter-kit)
